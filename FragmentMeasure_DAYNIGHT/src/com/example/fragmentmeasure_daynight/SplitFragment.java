package com.example.fragmentmeasure_daynight;
/*Adapted and code from http://appheads.ru/*/
...
public class SplitFragment {
    ...
    public SplitFragment(int pageWidth, int pageHeight, float lineSpacingMultiplier, int lineSpacingExtra) {
